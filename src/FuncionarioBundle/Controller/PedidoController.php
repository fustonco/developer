    ...
    */
    ...
    public function cadastrarPedidoAction(Request $request)
    {
        ...
        try {
            ...
            $tipo = $em->getRepository('FuncionarioBundle:TipoPedido')->findOneById($request->tipopedido);
            $pedido->setIdtipo($tipo);
            $fornecedor = $em->getRepository('FuncionarioBundle:Fornecedor')->findOneById($request->forn);
            ...
            for ($i = 0; $i < count($pagamentos); $i++) {
                ...
                switch($tipo_pagamento->getId()){
                    case 2:
                        $cartao = $em->getRepository('FuncionarioBundle:Cartao')->findOneBy(array(
                    ...
                    case 6:
                        ...
                        $contaTipo = $em->getRepository('FuncionarioBundle:ContaTipo')->findOneById($pagamentos[$i]->conta->tipo);
            ...
            $de = $em->getRepository('FuncionarioBundle:Funcionario')->findOneById($this->getUser()->getId());
            $historico->setIdde($de);
            $para = $em->getRepository('FuncionarioBundle:Funcionario')->findOneById($request->para);
            $historico->setIdpara($para);
            $historico->setDataPassagem($hoje);
