...
class Parcelas
{
    ...
    /**
     * @var \LoginBundle\Entity\Pagamento
     */
    private $idpagamento;

    /**
     * @var \LoginBundle\Entity\StatusParcela
     */
    private $status;
     ...
     * Set idpagamento
     *
     * @param \LoginBundle\Entity\Pagamento $idpagamento
     * @return Parcelas
     */
    public function setIdpagamento(\LoginBundle\Entity\Pagamento $idpagamento = null)
    {
     ...
     * Get idpagamento
     *
     * @return \LoginBundle\Entity\Pagamento 
     */
     ...
     * Set status
     *
     * @param \LoginBundle\Entity\StatusParcela $status
     * @return Parcelas
     */
    public function setStatus(\LoginBundle\Entity\StatusParcela $status = null)
    {
        $this->status = $status;
     ...
     * Get status
     *
     * @return \LoginBundle\Entity\StatusParcela 
     */
